...
export default function Footer () {
    return (
        <div className="relative flex flex-col items-center">
            ...
            <Image src='./Logo (1).svg' width={100} height={100}/>
            ...
            <div className="flex space-x-4 mt-24">
                <Image src='./Facebook.svg' width={50} height={100}/>
                <Image src='./Telegram.svg' width={50} height={100}/>
                <Image src='./Intagram.svg' width={50} height={100}/>
                <Image src='./Twitter.svg' width={50} height={100}/>
            </div>
            </div></div>
            {/*Inside content */}
