...
export default function WhyJoin () {
    return (
        <div className="h-[60vh] p-10 flex flex-col mt-4 items-center justify-center">
            ...
            <h2 className="2xl:text-6xl font-semibold text-[#6BCCD5] md:text-3xl">Why Join FUR&apos;EVER?</h2>
            <Image 
    src='./Head Blink.svg' 
    alt="FurrEver Character" 
    width={100} 
    height={100} 
    className="blinking-head"
/>

            </div>
            <p className="text-black 2xl:text-3xl w-[80%] text-center mt-14 md:text-xl">FUR&apos;EVER is more than just a cryptocurrency—it&apos;s a movement dedicated to protecting and supporting animals in need. By leveraging blockchain technology and a community-driven approach, we ensure that every transaction directly contributes to verified animal welfare organizations, shelters, and rescue initiatives worldwide.</p>
        </div>
    );
};