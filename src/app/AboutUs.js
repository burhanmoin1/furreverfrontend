...
export default function AboutUs() {
    return (
        <div className="flex flex-col mb-14 items-center 2xl:h-[60vh] md:h-[100vh] space-y-14 text-black w-screen mt-24">
            <h2 className="text-6xl font-semibold text-[#6BCCD5] tracking-[4.5px]">About Us</h2>
            <div className="flex flex-col md:flex-row space-y-4 items-center justify-between 2xl:w-[60%] md:w-[80%] md:space-x-10 mt-4">
                {[
                    ...
                    <div key={index} className=" border-[2px] border-[#6BCCD5] flex flex-col space-y-4 text-center items-center justify-center bg-[#D6F8FB] 2xl:w-[28%] md:w-[38%] w-[90%] h-[300px] rounded-lg relative group p-4">
