...
export default function AboutUs () {
    return (
        <div className="flex flex-col items-center justify-center 2xl:h-[100vh] md:h-[60vh] space-y-14 text-black w-screen">
            <h2 className="text-6xl font-semibold text-[#6BCCD5] tracking-[4.5px] 2xl:mt-22">About Us</h2>
